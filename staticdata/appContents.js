export const appText = {
      ...
      managedNodes: {
            ...
            icon: "/managednodes.png",
            trademark: false,
      },
      nodeAsService: {
            title: "Nodes as a services",
            content: [
      ...
      bScalability: {
            ...
            content: [
                  "Leverage scalable blockchain infrastructure and a substantial and growing community of committed datapreneurs for rapid and effective scaling of blockchain-based applications. Maintain high performance and security in a decentralized approach",
            ],
            icon: "/bchain.png",
            trademark: false,
      },
      pStake: {
            ...
            content: [
                  "Proof of stake blockchain validation is more environmentally friendly than proof of work, as it consumes significantly less energy by not requiring computational puzzles to be solved. Validators are selected based on cryptocurrency holdings, reducing the carbon footprint of the network.",
                  "Unless directly disclosed none of the projects we support will operate through the Proof of work",
            ],
            icon: "/PS.png",
            trademark: false,
      },
      cComputing: {
            ...
            content: [
                  ...
                  "Overall, cloud computing provides an eco-friendly and efficient solution for validating and recording transaction on PoS blockchains",
            ],
            icon: "/cComp.png",
            trademark: false,
      },
